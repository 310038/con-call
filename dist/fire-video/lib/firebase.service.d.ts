...
export declare class FirebaseService {
     ...
     * @param collectionName collection名稱，預設collectionName 叫做 rooms
     */
    getCollectionRef(collectionName: string): import("@angular/fire/compat/firestore").AngularFirestoreCollection<unknown>;
     ...
     */
    updateDataToDoc(collectionName: string, roomId: string, data: object): void;
